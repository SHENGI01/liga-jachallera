...
const categorias = {
  ...
  primera: {
    ...
    goleadores: [
      ...
      { nombre: "Alejo Santana", goles: 7, equipo: "El Rincon" },
      ...
      { nombre: "Brian Juares", goles: 7, equipo: "Florida" },
      ...
      { nombre: "Leonel Jofre", goles: 13, equipo: "Racing" },
      { nombre: "Ever Ortiz", goles: 2, equipo:"Niquivil" },
      { nombre: "Lisandro Almazan", goles: 11, equipo:"San Lorenzo" },
     ...
     { nombre: "Franco Manrique", goles: 3, equipo:"Central Norte" },
      ...
      { nombre: "Santiago Riveros", goles: 5, equipo: "El Rincon" },
...
{ nombre: "Franco Santana", goles: 3, equipo: "Pampa" },
      ...
      { nombre: "Emanuel Muñoz", goles: 1, equipo:"Central Norte" },
       ...
       { nombre: "Braian Muñoz", goles: 2, equipo: "Andacollo" },
