...
const categorias = {
  ...
  primera: {
    ...
    fecha2: [
      ...
      fecha9: [
        { local: "Arbol Verde", visitante: "Andacollo",golesL: 3, golesV: 0,cancha:"arbol verde", hora: "16:30", estado: "finalizado" },
        { local: "Estrella", visitante: "Florida",golesL: 1, golesV: 1,cancha: "estrella", hora: "16:30", estado: "finalizado" },
        { local: "Peñarol", visitante: "Pampa",golesL: 0, golesV: 1,cancha: "peñarol", hora: "16:30", estado: "finalizado" },
        { local: "Niquivil", visitante: "Pampa Vieja",golesL: 2, golesV: 0,cancha: "arbol verde", hora: "14:00", estado: "finalizado" },
        { local: "Racing", visitante: "San Lorenzo",golesL: 2, golesV: 1,cancha: "peñarol", hora: "14:00", estado: "finalizado" },
        { local: "Central Norte", visitante: "El Rincon",golesL: 1, golesV: 3,cancha: "estrella", hora: "14:00", estado: "finalizado" }
      ],
      fecha10: [
        { local: "Central Norte", visitante: "Peñarol",golesL: 2, golesV: 1,cancha:"peñarol", hora: "16:30", estado: "finalizado" },
        { local: "Estrella", visitante: "San Lorenzo",golesL: 2, golesV: 1,cancha: "san lorenzo", hora: "16.00", estado: "finalizado" },
        { local: "Florida", visitante: "Pampa Vieja",golesL: 2, golesV: 1,cancha: "pampa vieja", hora: "16:30", estado: "finalizado" },
        { local: "El Rincon", visitante: "Arbol Verde",golesL: 0, golesV: 0,cancha: "san lorenzo", hora: "14:00", estado: "finalizado" },
        { local: "Racing", visitante: "Pampa",golesL: 3, golesV: 2,cancha: "pampa vieja", hora: "14:00", estado: "finalizado" },
        { local: "Niquivil", visitante: "Andacollo",golesL: 1, golesV: 1,cancha: "peñarol", hora: "14:00", estado: "finalizado" }
      ],
      fecha11: [
        { local: "Florida", visitante: "Andacollo",golesL: 4, golesV: 2,cancha:"andacollo", hora: "16:30", estado: "finalizado" },
        { local: "Racing", visitante: "Central Norte",golesL: 2, golesV: 1,cancha: "racing", hora: "16:30", estado: "finalizado" },
        { local: "Peñarol", visitante: "El Rincon",golesL: 3, golesV: 0,cancha: "san lorenzo", hora: "16:30", estado: "finalizado" },
        { local: "Niquivil", visitante: "Arbol Verde",golesL: 2, golesV: 4,cancha: "andacollo", hora: "14.00", estado: "finalizado" },
        { local: "Pampa Vieja", visitante: "San Lorenzo",golesL: 0, golesV: 3,cancha: "san lorenzo", hora: "14:00", estado: "finalizado" },
        { local: "Estrella", visitante: "Pampa",golesL: 3, golesV: 2,cancha: "racing", hora: "14:00", estado: "finalizado" }
      ],
     
      fecha12: [
        { local: "Arbol Verde", visitante: "Peñarol",golesL: 0, golesV: 0,cancha:"peñarol", hora: "16:30", estado: "finalizado" },
        { local: "Florida", visitante: "Niquivil",golesL: 2, golesV: 2,cancha: "florida", hora: "16:30", estado: "finalizado" },
        { local: "Estrella", visitante: "Central Norte",golesL: 2, golesV: 1,cancha: "estrella", hora: "16:30", estado: "finalizado" },
        { local: "El Rincon", visitante: "Racing",golesL: 2, golesV: 0,cancha: "florida", hora: "14:00", estado: "finalizado" },
        { local: "Pampa Vieja", visitante: "Pampa",golesL: 1, golesV: 1,cancha: "peñarol", hora: "14:00", estado: "finalizado" },
       ...
       fecha13: [
        ...
        { local: "Pampa Vieja", visitante: "Central Norte",golesL: 1, golesV: 2,cancha: "peñarol", hora: "16:00", estado: "finalizado" },
        { local: "Peñarol", visitante: "Racing",golesL: 3, golesV: 3,cancha: "peñarol", hora: "14:00", estado: "finalizadado" }
      ],
      fecha14: [
        { local: "Florida", visitante: "San Lorenzo",golesL: 3, golesV: 4,cancha:"florida", hora: "16:00", estado: "finalizado" },
        { local: "Estrella", visitante: "Peñarol",golesL: 1, golesV: 1,cancha: "estrella", hora: "16:00", estado: "finalizado" },
        { local: "Pampa Vieja", visitante: "El Rincon",golesL: 0, golesV: 2,cancha: "pampa vieja", hora: "16:00", estado: "finalizado" },
        { local: "Andacollo", visitante: "Central Norte",golesL: 1, golesV: 1,cancha: "pampa vieja", hora: "14:00", estado: "finalizado" },
        { local: "Racing", visitante: "Arbol Verde",golesL: 2, golesV: 1,cancha: "florida", hora: "14:00", estado: "finalizado" },
    ...
    goleadores: [
      ...
      { nombre: "Alejo Santana", goles: 6, equipo: "El Rincon" },
      { nombre: " Javier Oro", goles: 4, equipo:"Central Norte" },
       { nombre: " Nestor Celan", goles: 15, equipo:"Arbol Verde" },
      ...
      { nombre: "Lucas Suesa", goles: 2, equipo: "Arbol Verde" },
      { nombre: "Jose Femenia", goles: 1, equipo: "Arbol Verde" },
      { nombre: "Lucas Nievas", goles: 2, equipo: "Arbol Verde" },
      {nombre: "Eduardo Felis", goles: 6, equipo: "Peñarol" },
      { nombre: "Ramon Avila", goles: 4, equipo:"Estrella" },
      { nombre: "Ivan Santana", goles: 3, equipo:"Estrella" },
      { nombre: "Jere Neira", goles: 1, equipo:"Niquivil" },
      { nombre: "Brian Juares", goles: 6, equipo: "Florida" },
      ...
      { nombre: "Leonel Jofre", goles: 11, equipo: "Racing" },
      { nombre: "Ever Ortiz", goles: 2, equipo:"Niquivil" },
      { nombre: "Lisandro Almazan", goles: 10, equipo:"San Lorenzo" },
      { nombre: "Marcelo Balmaceda", goles: 2, equipo:"Estrella" },
      { nombre: "Santiago Castillo", goles: 4, equipo:"Andacollo" },
      { nombre: "Matias Montaño", goles: 2, equipo: "El Rincon" },
      {nombre: "Gonzalo Pasten", goles: 6, equipo: "Peñarol" },
      {nombre: "Osvaldo Maza", goles: 4, equipo: "Niquivil" },
       { nombre: "Matias Vega", goles: 1, equipo: "Pampa" },
       { nombre: "Ali Casivar", goles: 3, equipo: "Pampa" },
     { nombre: "Franco Manrique", goles: 2, equipo:"Central Norte" },
      { nombre: "Santiago Tapia", goles: 1, equipo: "Florida" },
      { nombre: "Bastian Pereyra", goles: 1, equipo:"Estrella" },
      { nombre: "Diego Solares", goles: 5, equipo:"Estrella" },
      { nombre: "Santiago Riveros", goles: 4, equipo: "El Rincon" },
...
{ nombre: "Franco Santana", goles: 3, equipo: "Pampa" },
      { nombre: "Diego Toledo", goles: 1, equipo:"San Lorenzo" },
       ...
       { nombre: "Franco Fuentes", goles: 4, equipo: "Racing" },
      ...
      { nombre: "Mateo Castro", goles: 1, equipo:"Andacollo" },
       ...
       { nombre: "Luciano Alvarez", goles: 2, equipo:"Pampa Vieja" },
      {nombre: "Facundo Quinteros", goles: 1, equipo: "Peñarol" },
      { nombre: "Emanuel Muñoz", goles: 1, equipo:"Central Norte" },
       { nombre: "Braian Muñoz", goles: 1, equipo: "Pampa" },
       { nombre: "Raul Paez", goles: 1, equipo: "Pampa" },
       { nombre: "Rodrigo Caballero", goles: 3, equipo: "Florida" },
       {nombre: "Alfredo Aciar", goles: 2, equipo: "Peñarol" },
       { nombre: "Cristian Funes", goles: 3, equipo:"San Lorenzo" },
       { nombre: "Braian Muñoz", goles: 1, equipo: "Andacollo" },
      { nombre: "Maximiliano Martinez", goles: 2, equipo: "Racing" },
       { nombre: "Alberto Riveros", goles: 1, equipo:"Pampa Vieja" },
    ]
 ...
 fecha2: [
       ...
       fecha10: [
        { local: "La Falda", visitante: "Calle Varas",golesL: 1, golesV: 1,cancha: "san blas", hora: "14:00", estado: "finalizado" },
        { local: "San Blas", visitante: "Independiente",golesL: 1, golesV: 1,cancha: "san blas", hora: "16:30", estado: "finalizado" },
        { local: "La Frontera", visitante: "San Roque",golesL: 1, golesV: 1,cancha: "san martin", hora: "14:00", estado: "finalizado" },
        { local: "Huaco", visitante: "San Martin",golesL: 0, golesV: 3,cancha: " san martin", hora: "16:30", estado: "finalizado" },
        { local: "Boca del Medano", visitante: "Otra Banda",cancha: "libre", hora: "libre", estado: "libres" },
        
      ],
         fecha11: [
        { local: "Huaco", visitante: "Calle Varas",golesL: 1, golesV: 2,cancha: "hungaros", hora: "14:00", estado: "finalizado" },
        { local: "San Martin", visitante: "Independiente",golesL: 1, golesV: 3,cancha: "hungaros", hora: "16:30", estado: "finalizado" },
        { local: "La Falda", visitante: "San Blas",golesL: 1, golesV: 1,cancha: "la falda", hora: "14:00", estado: "finalizado" },
        ...
        { local: "Calle Varas", visitante: "Huaco",golesL: 3, golesV: 3,cancha: "san bla", hora: "14:00", estado: "finalizado" },
        ...
        { local: "La Falda", visitante: "Otra Banda",cancha: "libre", hora: "libre", estado: "libres" },
         ...
         fecha14: [
        { local: "San Roque", visitante: "Independiente",golesL: 0, golesV: 0,cancha: "san martin", hora: "14:00", estado: "finalizado" },
        { local: "San Martin", visitante: "La Falda",golesL: 1, golesV: 0,cancha: "san martin", hora: "16:00", estado: "finalizado" },
        { local: "Otra Banda", visitante: "Huaco",golesL: 1, golesV: 0,cancha: "la falda", hora: "16:00", estado: "finalizado" },
        ...
        fecha15: [
        { local: "Otra Banda", visitante: "Calle Varas",golesL: 3, golesV: 0,cancha: "huaco", hora: "14:00", estado: "finalizado" },
        { local: "Huaco", visitante: "Independiente",golesL: 2, golesV: 2,cancha: "huaco", hora: "16:00", estado: "finalizado" },
        { local: "La Falda", visitante: "San Roque",golesL: 6, golesV: 1,cancha: "arbol verde", hora: "14:00", estado: "finalizado" },
    ...
    goleadores: [
      ...
      { nombre: "Elias Aciar", goles: 7, equipo:" Otra Banda" },
       { nombre: "Cristian Pereyra", goles: 7, equipo:"La Frontera" },
      { nombre: "Yamil Muñoz", goles: 3, equipo:"San Martin" },
        { nombre: "Diego Aciar", goles: 3, equipo:"Otra Banda" },
     { nombre: "Alexis Lopez", goles: 1, equipo:"San Martin" },
      { nombre: "Sergio Carbajal", goles: 5, equipo:"San Martin" },
      { nombre: "Cristian Bordon", goles: 2, equipo:"Boca del Medano" },
      { nombre: "Emanuel Cabanay", goles: 4, equipo:"Independiente" },
      { nombre: "Bautista Carrizo", goles: 3, equipo:"La Falda" },
      { nombre: "Facundo Balmaceda", goles: 2,equipo:"La Falda" },
        { nombre: "Jorge Arancibia", goles: 2,equipo:"La Falda" },
      { nombre: "isac castro", goles: 5, equipo:"Independiente" },
      ...
      { nombre: "Facundo Garcia", goles: 4,equipo:"Huaco" },
       { nombre: "Luis Garcia", goles: 2,equipo:"Huaco" },
      { nombre: "Luciano Vega", goles: 1, equipo:"La Frontera" },
      { nombre: "Yoel Olguin", goles: 2, equipo:"Calle Varas" },
      ...
      { nombre: "Gonzalo Araoz", goles: 2, equipo:"San Blas" },
       ...
       { nombre: "Nicolas Rosselot", goles: 3, equipo:"San Roque" },
      { nombre: "Leonel Balmaceda", goles: 3, equipo:"San Blas" },
      { nombre: "Gaston Barrionuevo", goles: 2, equipo:"San Blas" },
         { nombre: "Gonzalo Araoz", goles: 2, equipo:"San Blas" },
       ...
       { nombre: "Miguel Roja", goles: 5, equipo:"La Frontera" },
       { nombre: "Omar Cortez", goles: 1, equipo:"La Frontera" },
       { nombre: "Florencio Perez", goles: 1, equipo:"La Frontera" },
       { nombre: "Rolando Castillo", goles: 5, equipo:"La Frontera" },
      ...
      { nombre: "Guillermo Paez", goles: 1, equipo:"Boca del Medano" },
       ...
       { nombre: "Carlos Aballay", goles: 1, equipo:"San Martin" },
        ...
        { nombre: "Rodrigo Heredia", goles: 3, equipo:"Otra Banda" },
      ...
      { nombre: "Enzo Castro", goles: 2, equipo:"Independiente" },
        { nombre: "Milton Sanchez", goles: 2, equipo:"Boca del Medano" },
        { nombre: "Felipe Olmos", goles: 1, equipo:"Boca del Medano" },
       { nombre: "Sergio Villafañe", goles: 2, equipo:"Calle Varas" },
      { nombre: "Jose Argumoza", goles: 1,equipo:"Huaco" },
      { nombre: "Roberto Muñoz", goles: 2, equipo:"San Martin" },
      { nombre: "Leonardo Muñoz", goles: 2, equipo:"San Martin" },
      { nombre: "Nestor Salinas", goles: 3, equipo:"La Falda" },
       { nombre: "Angel Arancibia", goles: 3, equipo:"San Blas" },
    ]
