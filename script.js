...
const categorias = {
  ...
  primera: {
    ...
    fecha2: [
      ...
      fecha5: [
        ...
        { local: "Racing", visitante: "Pampa Vieja",cancha: "andacollo", hora: "14:00", estado: "proximo" },
        { local: "El Rincon", visitante: "Niquivil",cancha: "san lorenzo", hora: "14:00", estado: "proximo" },
        { local: "Central Norte", visitante: "Florida",cancha: "arbor verde", hora: "14:00", estado: "proximo" }
      ],
      fecha6: [
 ...
 fecha2: [
       ...
       fecha4: [
        ...
        { local: "Otra Banda", visitante: "Independiente",golesL: 0, golesV: 0,cancha: "hungaros", hora: "16:30", estado: "vivo" },
        { local: "San Martin", visitante: "San Blas",golesL: 0, golesV: 2,cancha: "hungaros", hora: "14:00", estado: "finalizado" },
        { local: "Huaco", visitante: "La Frontera",golesL: 0, golesV: 0,cancha: " la falda", hora: "16:30", estado: "vivo" },
