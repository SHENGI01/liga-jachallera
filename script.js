...
const categorias = {
  ...
  primera: {
    ...
    fecha2: [
      ...
      fecha8: [
        { local: "Pampa", visitante: "El Rincon",cancha:"pampa", hora: "16:30", estado: "proximo" },
        { local: "Racing", visitante: "Florida",cancha: "florida", hora: "16:30", estado: "proximo" },
        { local: "Niquivil", visitante: "Estrella",cancha: "niquivil", hora: "16:30", estado: "proximo" },
        { local: "Arbol Verde", visitante: "Central Norte",cancha: "pampa", hora: "14:00", estado: "proximo" },
        { local: "San Lorenzo", visitante: "Peñarol",cancha: "florida", hora: "14:00", estado: "proximo" },
        { local: "Andacollo", visitante: "Pampa Vieja",cancha: "niquivil", hora: "14:00", estado: "proximo" }
      ],
      fecha9: [
...
{ nombre: "Franco Santana", goles: 3, equipo: "Pampa" },
 ...
 fecha2: [
       ...
       fecha8: [
        ...
        fecha9: [
        { local: "Otra Banda", visitante: "La Frontera",golesL: 1, golesV: 1,cancha: "arbol verde", hora: "14:00", estado: "proximo" },
        { local: "Boca del Medano", visitante: "  Independiente",golesL: 2, golesV: 4,cancha: "arbol verde", hora: "16:30", estado: "proximo" },
        { local: "Calle Varas", visitante: "San Martin",golesL: 1, golesV: 0,cancha: "huaco", hora: "14:00", estado: "proximo" },
        { local: "Huaco", visitante: "San Roque",golesL: 3, golesV: 1,cancha: " hueaco", hora: "16:30", estado: "proximo" },
    ...
    goleadores: [
      ...
      { nombre: "Elias Aciar", goles: 4, equipo:" Otra Banda" },
       { nombre: "Cristian Pereyra", goles: 3, equipo:"La Frontera" },
     ...
     { nombre: "Alexis Lopez", goles: 1, equipo:"San Martin" },
      ...
      { nombre: "Emanuel Cabanay", goles: 3, equipo:"Independiente" },
      ...
      { nombre: "Facundo Garcia", goles: 1,equipo:"Huaco" },
      ...
      { nombre: "Ismael Dias", goles: 2, equipo:"San Roque" },
