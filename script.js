...
const categorias = {
  ...
  primera: {
    ...
    fecha2: [
      ...
      fecha4: [
        ...
        { local: "San Lorenzo", visitante: "Arbol Verde",cancha: "pampa", hora: "14:00", estado: "proximo" },
        { local: "Estrella", visitante: "Racing",cancha: "san lorenzo", hora: "14:00", estado: "proximo" },
        { local: "Central Norte", visitante: "Niquivil",cancha: "pampa vieja", hora: "14:00", estado: "proximo" }
      ],
      fecha5: [
    ...
    goleadores: [
      ...
      { nombre: "Lisandro Almazan", goles: 2, equipo:"San Lorenzo" },
 ...
 fecha2: [
       ...
       fecha4: [
        { local: "La Falda", visitante: "San Roque",golesL: 2, golesV: 0, cancha: "la falda", hora: "14:00", estado: "vivo" },
        { local: "Huaco", visitante: "Independiente",golesL: 0, golesV: 0, cancha: "arbol verde", hora: "14:00", estado: "vivo" },
        { local: "Boca del Medano", visitante: "San Blas",cancha: "arbol verde", hora: "16:30", estado: "proximo" },
        { local: "Otra Banda", visitante: "Calle Varas", cancha: " la falda", hora: "16:30", estado: "proximo" },
