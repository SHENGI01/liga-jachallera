  ...
  primera: {
    ...
    fecha2: [
      ...
      fecha4: [
        ...
        { local: "Peñarol", visitante: "Pampa Vieja",golesL: 0, golesV: 1,cancha: "pampa vieja", hora: "16:30", estado: "finalizado" },
      ...
      fecha5: [
        ...
        { local: "Central Norte", visitante: "Florida",cancha: "albor verde", hora: "14:00", estado: "proximo" }
      ],
      fecha6: [
    ...
    goleadores: [
      ...
      { nombre: " Javier Oro", goles: 2, equipo:"Central Norte" },
       ...
       { nombre: " Federico Gomez", goles: 1, equipo:"Arbol Verde" },
         { nombre: " Enzo Diaz", goles: 2, equipo:"Arbol Verde" },
