...
const categorias = {
  ...
  primera: {
    ...
    fecha2: [
      ...
      fecha6: [
        { local: "Central Norte", visitante: "San Lorenzo",cancha:"peñarol", hora: "16:30", estado: "proximo" },
        { local: "Peñarol", visitante: "Niquivil",cancha: "niquivil", hora: "16:30", estado: "proximo" },
        { local: "Estrella", visitante: "Pampa Vieja",cancha: "pampa vieja", hora: "16:30", estado: "proximo" },
        { local: "Arbol Verde", visitante: "Pampa",cancha: "niquivil", hora: "14:00", estado: "proximo" },
        { local: "El Rincon", visitante: "Florida",cancha: "peñarol", hora: "14:00", estado: "proximo" },
        { local: "Andacollo", visitante: "Racing",cancha: "pampa vieja", hora: "14:00", estado: "proximo" }
      ],
      fecha7: [
    ...
    goleadores: [
      ...
      { nombre: "Alejo Santana", goles: 2, equipo: "El Rincon" },
      { nombre: " Javier Oro", goles: 2, equipo:"Central Norte" },
       { nombre: " Nestor Celan", goles: 5, equipo:"Arbol Verde" },
      ...
      { nombre: "Leonel Jofre", goles: 4, equipo: "Racing" },
      { nombre: "Ever Ortiz", goles: 2, equipo:"Niquivil" },
      { nombre: "Lisandro Almazan", goles: 4, equipo:"San Lorenzo" },
      ...
      { nombre: "Eneas Montaño", goles: 1, equipo:"Central Norte" },
     { nombre: "Franco Manrique", goles: 1, equipo:"Central Norte" },
      ...
      { nombre: "Santiago Riveros", goles: 2, equipo: "El Rincon" },
 ...
 fecha2: [
       ...
       fecha6: [
        { local: "Calle Varas", visitante: "Boca del Medano",cancha: "san martin", hora: "14:00", estado: "proximo" },
        { local: "San Martin", visitante: "La Falda",cancha: "san martin", hora: "16:30", estado: "proximo" },
        { local: "Otra Banda", visitante: "Huaco",cancha: "san blas", hora: "14:00", estado: "proximo" },
    ...
    goleadores: [
     ...
     { nombre: "Alexis Lopez", goles: 1, equipo:"San Martin" },
      ...
      { nombre: "Juan Manrique", goles: 1,equipo:"La Falda" },
        { nombre: "Justiniano Carrasco", goles: 2,equipo:"La Falda" },
      { nombre: "Milton Andrada", goles: 1,equipo:"Huaco" },
       { nombre: "Luis Garcia", goles: 1,equipo:"Huaco" },
      ...
      { nombre: "Leonel Balmaceda", goles: 1, equipo:"San Blas" },
