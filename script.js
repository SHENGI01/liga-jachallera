...
const categorias = {
  ...
  primera: {
    ...
    goleadores: [
      ...
      { nombre: "Ramon Avila", goles: 2, equipo:"Estrella" },
      ...
      { nombre: "Leonel Jofre", goles: 10, equipo: "Racing" },
      ...
      { nombre: "Santiago Castillo", goles: 2, equipo:"Andacollo" },
     ...
     { nombre: "Franco Manrique", goles: 2, equipo:"Central Norte" },
      ...
      { nombre: "Diego Solares", goles: 4, equipo:"Estrella" },
